    ...
    <footer className="footer">
          ...
          <div className="footer__grid">
            <div className="footer__brand">
              <Link href="/" className="footer__logo">
                <img src="/logo.png" alt="DiliTours" width={36} height={36} className="footer__logo-img" />
                <span>Dili<strong>Tours</strong></span>
              </Link>
              <p>Tu agencia de viajes de confianza en Tepic, Nayarit. Creamos experiencias inolvidables para cada tipo de viajero.</p>
              <div className="footer__social">
                <a href={agency.social.facebook} target="_blank" rel="noreferrer" aria-label="Facebook" className="social-icon">
                  <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
                </a>
                <a href={agency.social.tiktok} target="_blank" rel="noreferrer" aria-label="TikTok" className="social-icon">
                ...
                <a href={agency.social.whatsapp} target="_blank" rel="noreferrer" aria-label="WhatsApp" className="social-icon">
            ...
            <div className="footer__contact-col">
              ...
              <div className="footer__contact-item">
                ...
                <span>{agency.contact.address}<br />{agency.contact.city}</span>
              </div>
              <div className="footer__contact-item">
                <span className="footer__contact-dot" />
                <a href={agency.contact.phoneRaw}>{agency.contact.phone}</a>
              </div>
              <div className="footer__contact-item">
                <span className="footer__contact-dot" />
                <a href={agency.contact.emailMailto}>{agency.contact.email}</a>
              </div>
              <div className="footer__contact-item">
                <span className="footer__contact-dot" />
      ...
      <div className="footer__bottom">
        <div className="container footer__bottom-inner">
          <p>© {year} {agency.name}. Todos los derechos reservados.</p>
